...
class ReservationShow extends React.Component {
    ...
    // debugger
      if (this.haveHours) {
        ...
        this.setState({
          ...
          restaurantHours: getRestaurantHours(this.props.restaurant.open_time, this.props.restaurant.close_time),
          // slots: [this.state.restaurantHours[0], this.state.restaurantHours[1], this.state.restaurantHours[2]]
        })
  ...
  render() {
    // debugger
    const timeSlots = this.state.restaurantHours.map((time, i) => <option key={i} id="select-option" value={time}>{time.toLocaleString('en-US', { hour: 'numeric', minute: 'numeric', hour12: true })}</option>)
