...
User.create!(email: "user1@ht.com", first_name: "Tony", last_name: "Montana", primary_location: "Queens", password: "fireball42")
User.create!(email: "user2@ht.com", first_name: "Pablo", last_name: "Escobar", primary_location: "Brooklyn", password: "fireball42")
